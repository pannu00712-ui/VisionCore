...
echo  [3/7] Adding WiX extensions...
...
:: ── Step 4: Publish x64 ──────────────────────────────────────────────────────
echo  [4/7] Publishing x64 (Release)...
...
:: ── Step 5: Publish x86 ──────────────────────────────────────────────────────
echo  [5/7] Publishing x86 (Release)...
...
:: ── Step 6: Build x64 installer ──────────────────────────────────────────────
echo  [6/7] Building x64 installer...
dotnet build "%ROOT%\VisionCore.Installer\VisionCore.Installer.csproj" ^
    ...
    /p:Platform=x64
if errorlevel 1 ( echo  [ERROR] x64 installer build failed. & pause & exit /b 1 )
echo         OK

:: ── Step 7: Build x86 installer ──────────────────────────────────────────────
echo  [7/7] Building x86 installer...
dotnet build "%ROOT%\VisionCore.Installer\VisionCore.Installer.csproj" ^
    -c Release ^
...
if errorlevel 1 ( echo  [ERROR] x86 installer build failed. & pause & exit /b 1 )
echo         OK
